...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1351: o => o instanceof Uint8ClampedArray,
      _1352: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1353: o => o instanceof Uint16Array,
      _1354: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1355: o => o instanceof Int16Array,
      _1356: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1357: o => o instanceof Uint32Array,
      _1358: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1359: o => o instanceof Int32Array,
      _1360: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1362: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1363: o => o instanceof Float32Array,
      _1364: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1365: o => o instanceof Float64Array,
      ...
      _1413: () => Date.now(),
      _1418: o => Object.keys(o),
      _1435: (x0,x1) => x0.createElement(x1),
      ...
      _1447: (x0,x1) => x0.appendChild(x1),
      _1448: (x0,x1) => x0.item(x1),
      _1449: (x0,x1) => x0.key(x1),
      _1459: (s, m) => {
        try {
      ...
      _2944: (x0,x1) => { x0.async = x1 },
      _2958: (x0,x1) => { x0.charset = x1 },
      _3407: () => globalThis.window,
      _3734: x0 => x0.localStorage,
      _4067: x0 => x0.length,
      _6024: x0 => x0.length,
      _6085: () => globalThis.document,
      _6169: x0 => x0.head,
